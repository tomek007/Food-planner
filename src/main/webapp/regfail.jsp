            ...
            <div class="container w-25">
                ...
                <form class="padding-small text-center" method="post" action="/register">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" value="${admin.firstName}">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="surname" name="surname" value="${admin.lastName}">
                    </div>
                    <div class="form-group">
...
<script>alert("Ten e-mail istnieje już w bazie. Podaj inny e-mail");</script>
